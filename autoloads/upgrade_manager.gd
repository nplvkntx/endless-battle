...
## Costs and multipliers live in UpgradeStats — edit there only.
...
const MAX_LEVEL: int = UpgradeStats.BLACKSMITH_MAX_LEVEL
const ACADEMY_MAX_LEVEL: int = UpgradeStats.ACADEMY_MAX_LEVEL
const CAVALRY_ATTACK_DAMAGE_PER_LEVEL: int = UpgradeStats.CAVALRY_ATTACK_DAMAGE_PER_LEVEL
const CAVALRY_DEFENSE_ARMOR_PER_LEVEL: int = UpgradeStats.CAVALRY_DEFENSE_ARMOR_PER_LEVEL
const STABLE_UPGRADE_BASE_GOLD: int = UpgradeStats.STABLE_UPGRADE_BASE_GOLD
const STABLE_UPGRADE_BASE_WOOD: int = UpgradeStats.STABLE_UPGRADE_BASE_WOOD
const STABLE_UPGRADE_GOLD_PER_LEVEL: int = UpgradeStats.STABLE_UPGRADE_GOLD_PER_LEVEL
const STABLE_UPGRADE_WOOD_PER_LEVEL: int = UpgradeStats.STABLE_UPGRADE_WOOD_PER_LEVEL
const LEVEL_COSTS: Array[int] = UpgradeStats.BLACKSMITH_LEVEL_COSTS
const FASTER_GATHERING_SPEED_MULTIPLIER: float = UpgradeStats.FASTER_GATHERING_SPEED_MULTIPLIER
const FASTER_UNIT_TRAINING_SPEED_MULTIPLIER: float = (
	UpgradeStats.FASTER_UNIT_TRAINING_SPEED_MULTIPLIER
)
const IMPROVED_TOOLS_CONSTRUCTION_SPEED_MULTIPLIER: float = (
	UpgradeStats.IMPROVED_TOOLS_CONSTRUCTION_SPEED_MULTIPLIER
)
const ENGINEERING_MAX_HEALTH_MULTIPLIER: float = UpgradeStats.ENGINEERING_MAX_HEALTH_MULTIPLIER
const BALLISTICS_DAMAGE_MULTIPLIER: float = UpgradeStats.BALLISTICS_DAMAGE_MULTIPLIER
...
const ACADEMY_UPGRADE_COSTS: Dictionary = {
	UPGRADE_FASTER_GATHERING: {
		"gold": UpgradeStats.ACADEMY_FASTER_GATHERING_GOLD,
		"wood": UpgradeStats.ACADEMY_FASTER_GATHERING_WOOD,
	},
	UPGRADE_FASTER_UNIT_TRAINING: {
		"gold": UpgradeStats.ACADEMY_FASTER_UNIT_TRAINING_GOLD,
		"wood": UpgradeStats.ACADEMY_FASTER_UNIT_TRAINING_WOOD,
	},
	UPGRADE_IMPROVED_TOOLS: {
		"gold": UpgradeStats.ACADEMY_IMPROVED_TOOLS_GOLD,
		"wood": UpgradeStats.ACADEMY_IMPROVED_TOOLS_WOOD,
	},
	UPGRADE_ENGINEERING: {
		"gold": UpgradeStats.ACADEMY_ENGINEERING_GOLD,
		"wood": UpgradeStats.ACADEMY_ENGINEERING_WOOD,
	},
	UPGRADE_BALLISTICS: {
		"gold": UpgradeStats.ACADEMY_BALLISTICS_GOLD,
		"wood": UpgradeStats.ACADEMY_BALLISTICS_WOOD,
	},
}

const ACADEMY_UPGRADE_RESEARCH_SECONDS: Dictionary = {
	UPGRADE_FASTER_GATHERING: UpgradeStats.ACADEMY_FASTER_GATHERING_SECONDS,
	UPGRADE_FASTER_UNIT_TRAINING: UpgradeStats.ACADEMY_FASTER_UNIT_TRAINING_SECONDS,
	UPGRADE_IMPROVED_TOOLS: UpgradeStats.ACADEMY_IMPROVED_TOOLS_SECONDS,
	UPGRADE_ENGINEERING: UpgradeStats.ACADEMY_ENGINEERING_SECONDS,
	UPGRADE_BALLISTICS: UpgradeStats.ACADEMY_BALLISTICS_SECONDS,
}
