...
## Keep Quaternius Blacksmith materials untouched; team identity comes from the selection ring.
func apply_team_visuals() -> void:
	_restore_blacksmith_visual_materials()


func _restore_blacksmith_visual_materials() -> void:
