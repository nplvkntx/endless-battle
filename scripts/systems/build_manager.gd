...
## Building costs / build times — edit BuildingStats only (shared with AI).
...
const WALL_SEGMENT_GOLD_COST: int = BuildingStats.WALL_SEGMENT_GOLD_COST
const WALL_SEGMENT_WOOD_COST: int = BuildingStats.WALL_SEGMENT_WOOD_COST
...
const CONSTRUCTION_DURATION_ONE_WORKER: float = BuildingStats.CONSTRUCTION_DURATION_ONE_WORKER
const CONSTRUCTION_DURATION_TWO_WORKERS: float = BuildingStats.CONSTRUCTION_DURATION_TWO_WORKERS
const CONSTRUCTION_DURATION_THREE_PLUS_WORKERS: float = (
	BuildingStats.CONSTRUCTION_DURATION_THREE_PLUS_WORKERS
)
const SHOP_CONSTRUCTION_DURATION_ONE_WORKER: float = (
	BuildingStats.SHOP_CONSTRUCTION_DURATION_ONE_WORKER
)
const SHOP_CONSTRUCTION_DURATION_TWO_WORKERS: float = (
	BuildingStats.SHOP_CONSTRUCTION_DURATION_TWO_WORKERS
)
const SHOP_CONSTRUCTION_DURATION_THREE_PLUS_WORKERS: float = (
	BuildingStats.SHOP_CONSTRUCTION_DURATION_THREE_PLUS_WORKERS
)
const WALL_SEGMENT_CONSTRUCTION_DURATION_ONE_WORKER: float = (
	BuildingStats.WALL_SEGMENT_CONSTRUCTION_DURATION_ONE_WORKER
)
const WALL_SEGMENT_CONSTRUCTION_DURATION_TWO_WORKERS: float = (
	BuildingStats.WALL_SEGMENT_CONSTRUCTION_DURATION_TWO_WORKERS
)
const WALL_SEGMENT_CONSTRUCTION_DURATION_THREE_PLUS_WORKERS: float = (
	BuildingStats.WALL_SEGMENT_CONSTRUCTION_DURATION_THREE_PLUS_WORKERS
)
...
func _get_construction_speed_multiplier() -> float:
	return UpgradeManager.get_construction_speed_multiplier(false)
