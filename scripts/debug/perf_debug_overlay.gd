...
func _update_label() -> void:
	...
	var lines: PackedStringArray = PackedStringArray([
		...
		"V2 Destination: %s" % PerfCounters.get_military_ai_v2_destination(),
		"V2 Objective: %s" % PerfCounters.get_military_ai_v2_objective(),
		"V2 Order: %s" % PerfCounters.get_military_ai_v2_active_order(),
		"V2 Last Order: %s" % PerfCounters.get_military_ai_v2_last_order_time(),
		"V2 Last Mission Change: %s" % PerfCounters.get_military_ai_v2_last_mission_change(),
